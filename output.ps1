...
Copy-Item -Recurse -Force -Verbose "./output/rn_issue_auto_archiving" -Destination "$RN_ALL_ISSUES_REPO_PATH/"
...
Copy-Item -Recurse -Force -Verbose "./output/rn_issue_auto_archiving" -Destination "$RN_INTERNAL_ISSUES_REPO_PATH/"
